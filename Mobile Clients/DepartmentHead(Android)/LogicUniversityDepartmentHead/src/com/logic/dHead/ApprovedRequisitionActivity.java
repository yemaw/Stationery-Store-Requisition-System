...
public class ApprovedRequisitionActivity extends ListActivity{
@Override
protected void onCreate(Bundle savedInstanceState) {
	...
	setListAdapter(new RequisitionListAdapter(this, loadAllApprovedRequisitions(access_token)));
}

public boolean onCreateOptionsMenu(android.view.Menu menu) {
	 getMenuInflater().inflate(R.menu.approved_activity_menu, menu);
	 return true;
}
...
public ArrayList<Requisition> loadAllApprovedRequisitions(String accessToken){
	ArrayList<Requisition> requisitions = new ArrayList<Requisition>();
	List<NameValuePair> params = new ArrayList<NameValuePair>();
	params.add(new BasicNameValuePair("access_token", accessToken));
	params.add(new BasicNameValuePair("method", "loadAllApprovedRequisitions"));
	try{
