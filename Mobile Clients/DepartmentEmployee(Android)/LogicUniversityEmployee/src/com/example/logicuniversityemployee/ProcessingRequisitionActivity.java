...
public class ProcessingRequisitionActivity extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RequisitionAdapter adapter = new RequisitionAdapter(this, loadAllProcessingRequisitions(access_token));
	...
	public ArrayList<Requisition> loadAllProcessingRequisitions(String accessToken){
		ArrayList<Requisition> requisitions = new ArrayList<Requisition>();
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("accessToken", accessToken));
		params.add(new BasicNameValuePair("method", "loadAllProcessingRequisitions"));
		try{
