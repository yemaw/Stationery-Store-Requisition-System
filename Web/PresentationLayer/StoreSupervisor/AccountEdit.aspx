<%@ Page Title="" Language="C#" MasterPageFile="~/TemplatesWeb/StoreSupervisor_Template.Master" AutoEventWireup="true" CodeBehind="AccountEdit.aspx.cs" Inherits="PresentationLayer.StoreSupervisor.AccountEdit" %>
...
<table class="table" style="margin:0 auto;text-align:left;width:400px;padding:20px;max-width:640px;">
        <tr>
