<%@ Page Title="" Language="C#" MasterPageFile="~/TemplatesWeb/StoreClerk_Template.Master" AutoEventWireup="true" CodeBehind="OrderArrivalCreation.aspx.cs" Inherits="PresentationLayer.StoreClerk.OrderArrivalCreation" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="content_title_container">
    <asp:Label ID="ui_content_title_label" runat="server" Text="Order Arrival" class="content_title"></asp:Label>
</div>
        ...
        <table style="margin:0 auto;text-align:left;width:400px;" class="table">
            <tr>
                ...
                <asp:AutoCompleteExtender ID="TextBox1_AutoCompleteExtender" runat="server" 
                    ...
                    ServiceMethod="GetCompletionList" ServicePath="OrderArrivalCreation.aspx" 
