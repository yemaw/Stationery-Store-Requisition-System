...
<td><asp:TextBox ID="ui_to_textbox" runat="server"></asp:TextBox></td>
</tr>
<tr>
<td>
...
<tr>
<td>
    <asp:Label ID="ui_message_label" runat="server" Text="Message"></asp:Label>
    </td>
<td>
    <asp:TextBox ID="ui_message_textbox" runat="server" TextMode="MultiLine" 
...
<asp:Button ID="ui_send_button" runat="server" onclick="ui_send_button_Click" 
        Text="Send" class="btn btn-primary btn-medium" />&nbsp;&nbsp;
