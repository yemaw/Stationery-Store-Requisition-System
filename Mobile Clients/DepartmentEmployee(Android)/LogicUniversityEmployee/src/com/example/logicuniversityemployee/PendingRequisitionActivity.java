...
public class PendingRequisitionActivity extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RequisitionAdapter adapter = new RequisitionAdapter(this, loadAllPendingRequisitions(access_token));
	...
	public ArrayList<Requisition> loadAllPendingRequisitions(String accessToken){
		ArrayList<Requisition> requisitions = new ArrayList<Requisition>();
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("accessToken", accessToken));
		params.add(new BasicNameValuePair("method", "loadAllPendingRequisitions"));
		try{
